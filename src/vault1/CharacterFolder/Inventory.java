...
public class Inventory {
	...
	public static void main(String[] args) throws CharacterException, ClassNotFoundException, SQLException {
		...
		Inventory.consumables(playerStats, playerSP, 2);
		Inventory.consumables(playerStats, playerSP, 5);
		Inventory.consumables(playerStats, playerSP, 9);
	...
	public static void consumables(PlayerGameplayStats playerStats, PlayerSkillPoints playerSkillPoints, int id)
		...
		// System.out.println("Hello from the other side " + value); <------ LOL
